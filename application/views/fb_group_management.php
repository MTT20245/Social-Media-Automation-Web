                            ...
                            <table class="table table-striped table-bordered table-hover dt-responsive text-center" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    foreach ($result as $r) {
										...
										echo "<td><a class=\"fa fa-pencil fa-fw editcap\" title='Edit details' id='{$r['id']}' href='#'></a>&nbsp;&nbsp;&nbsp;<a class=\"fa fa-trash-o fa-fw delcap\" href='#' title='Delete group' id='{$r['id']}'></a></td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
